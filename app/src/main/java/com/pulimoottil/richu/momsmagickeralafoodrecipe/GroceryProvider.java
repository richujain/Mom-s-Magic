...
public class GroceryProvider extends ContentProvider {
    ...
    static final String PROVIDER_NAME = "com.pulimoottil.richu.momsmagickeralafoodrecipe";
    ...
    static {
        sURLMatcher.addURI("com.pulimoottil.richu.momsmagickeralafoodrecipe", "item", ITEMS);
        sURLMatcher.addURI("com.pulimoottil.richu.momsmagickeralafoodrecipe", "item/#", ITEMS_ID);
    }
